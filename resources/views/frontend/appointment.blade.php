        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="bradcam_text">
                    ...
                    <p><a href="/">Home /</a> Make An Appointment</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        {{-- <div class="d-none d-sm-block mb-5 pb-4"> --}}
            {{-- <div id="map" style="height: 480px; position: relative; overflow: hidden;"> --}}
                ...
                {{-- <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d234700.90002830673!2d77.24107939839845!3d23.19932387211503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c428f8fd68fbd%3A0x2155716d572d4f8!2sBhopal%2C%20Madhya%20Pradesh!5e0!3m2!1sen!2sin!4v1697890214910!5m2!1sen!2sin"
            ...
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input class="form-control valid" name="address" id="address" type="address"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input class="form-control valid" name="phoneNo" id="PhoneNo" type="PhoneNo"
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter PhoneNo'"
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>Victory Park, CHS Flat, 203 Plot - 65 Sec 17, K, Kalamboli Node, Panvel Raigarh(MH)</h3>
                        <p>Maharashtra, 410218</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                    <div class="media-body">
                        <h3>+91 70416 - 26655</h3>
